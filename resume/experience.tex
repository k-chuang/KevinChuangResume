...
\cventryupdate
    ...
    {June 2019 - Dec. 2019} % second date
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
 		\item {Designed \& implemented API layer of automatic video preview \& thumbnail generator microservice using \textbf{Django}, \textbf{Docker}, and \textbf{Kubernetes} and productionized, maintained, and monitored service on \textbf{GCP} (\textbf{Stackdriver}, \textbf{GKE}, \textbf{Pub/Sub}, \textbf{GCS}, \textbf{Cloud SQL}), \textbf{Codefresh}, and \textbf{Grafana}}
