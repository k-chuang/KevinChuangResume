...
\cventry
    ...
    {09/2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
 		\item {Built data pipelines with data quality checks for multi-channel, multi-touch marketing attribution to support marketing and analytics teams to better allocate spend and explore growth opportunities using \textbf{Python, Airflow, SQL, Segment, AWS (Redshift)}}
